...
#         # self.fields['name'].widget.attrs['placeholder'] = "Your name"
#         for field in self.fields:
#             self.fields[field].widget.attrs['class'] = input_css_class #so you can change class in css
...
# ProductAttachmentInlineFormSet = inlineformset_factory( #this inlineformset_factory is for the product manage view
#     Product,
#     ProductAttachment,
#     form = ProductAttachmentForm,
#     formset = ProductAttachmentModelFormSet,
